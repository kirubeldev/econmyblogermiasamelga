...
const Atricle1Card = ({date , type, title ,desc, img}) => {
  return (
    <div>
      <div className='max-w-6xl mx-auto mt-[28px] border border-[#BFBFBF
]  rounded-[10px] flex gap-6 p-5'>

<img src={img} alt="" />
<div>
    <p className='text-[16px] mb-2'>{date}</p>
    <button className='text-white rounded-[6px] flex items-center justify-center mb-4 bg-[#AF001E] py-[5px] px-[35px]'>{type}</button>
