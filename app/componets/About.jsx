...
/>
          ...
          <div className="absolute flex items-center gap-3 md:hidden lg:flex bottom-4 left-[45%]  bg-white rounded-2xl border px-4 py-[5px]">
            <Image
              ...
              className="md:w-[20px] md:h-[20px] h-[15px] w-[15px]"
            />
            <p className="text-[12px]  md:text-[14px] ">Financial Expert</p>{" "}
          </div>
        </div>
        ...
        <div className="md:ml-[60px] md:-mt-12 lg:ml-[100px] xl:ml-0">
          ...
          <p className="max-w-[578px] text-[18px]">
            Ermyas Amelga is a distinguished entrepreneur, economist, and
            financial expert whose vision and leadership have made significant
            impacts on Ethiopia&#39;s economic landscape and the broader African
            continent.
            <br />
            <br />
            With a unique blend of academic excellence, Wall Street experience,
            and entrepreneurial spirit, Ermyas has successfully navigated and
            shaped various industries, including banking, real estate,
